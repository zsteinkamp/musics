  ...
  const buttonIcon = () => {
    if (theme === THEME_DARK) {
      return (
        <svg
          ...
          height='24'
          viewBox='0 0 24 24'
          className='fill-themetoggle-dark
          opacity-50 transition-all
            hover:fill-themetoggle-hover-dark hover:opacity-100
          '
        >
          <path
            className=''
    ...
    return (
      <svg
        ...
        height='24'
        viewBox='0 0 24 24'
        className='fill-themetoggle-light
        opacity-50 transition-all
          hover:fill-themetoggle-hover-light hover:opacity-100
          '
      >
